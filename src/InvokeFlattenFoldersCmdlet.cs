...
public class InvokeFlattenFoldersCmdlet : PSCmdlet
{
    ...
    /// <summary>
    /// <para type="description">
    /// The strategy for renaming duplicate files. Valid values are "Guid" or "Index". Defaults to Index.
    /// </para>
    /// </summary>
    [Parameter(Mandatory = false)]
    [Alias("RM")]
    ...
    {
        get { return _renameMethod; }
        set { _renameMethod = value; }
    }
    private string _renameMethod = "Index";
    #endregion
    ...
    protected override void EndProcessing()
    {
        ...
        if(_renameMethod == "Index")
        {
            _container.RenameOption = RenameStrategy.Index;
        }
        else
        {
            _container.RenameOption = RenameStrategy.Guid;
        }
