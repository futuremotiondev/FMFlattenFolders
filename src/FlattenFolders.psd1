#
# Module manifest for module 'FMFlattenFolders'
#
...
@{
    ...
    GUID                 = '21B4D147-19B6-4E23-970A-F244259BFACD'
    ...
    Description          = 'A Powershell module that moves files from all sub-directories to the parent directory. Modified version by Futuremotion to include additional renaming options.'
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            IconUri    = 'https://github.com/futuremotiondev/FMFlattenFolders/blob/main/assets/images/ps7_icon_88.png'
    ...
    HelpInfoURI          = 'https://github.com/futuremotiondev/FMFlattenFolders'
